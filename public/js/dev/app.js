...
Vue.component('example-one', __webpack_require__(11));
// Vue.component(
// 	'affiliate-index',
...
Component.options.__file = "resources/assets/js/components/affiliate/ExampleOne.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-116c4a55", Component.options)
  } else {
    hotAPI.reload("data-v-116c4a55", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("code", [_vm._v("query: " + _vm._s(_vm.query))]),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-116c4a55", module.exports)
  }
}

...
class ProcedureTablesSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('procedure_documents')->insert([
            ...
            ['id' => '15', 'name' => 'Certificado de descendencia del titular fallecido emitido por el SERECI (original y actualizado).'],
            ...
            ['id' => '21', 'name' => 'Certificado de haberes otorgado por el comando general de la Policía Boliviana de los últimos 60 meses efectivamente percibidos, antes de su desvinculación laboral con la Institución Policial (original).'],
            ...
            ['id' => '23', 'name' => 'Certificado de trabajo emitido por el Comando General de la Policía Boliviana, que especifique la fecha de ingreso a la institución Policial, fecha de destino a disponibilidad, fecha de agradecimiento de servicio o fecha de baja.'],
            ...
            ['id' => '27', 'name' => 'Certificación emitida por la Dirección Nacional de Salud y Bienestar Social de la Policía Boliviana (original o copia legalizada)'],
            ['id' => '28', 'name' => 'Certificado de nacimiento del cónyuge original y actualizado'],
            ['id' => '29', 'name' => 'Certificado de defunción de la o el cónyuge original y actualizado'],
            ['id' => '30', 'name' => 'Fotocopia simple de la cédula de identidad del cónyuge'],

...
class AuxSeeder extends Seeder
{
    /**
    ...
    DB::table('procedure_requirements')->insert([
        ['procedure_modality_id' => '3', 'procedure_document_id' => '42', 'number' => '6'],
        ['procedure_modality_id' => '3', 'procedure_document_id' => '43', 'number' => '6'],        
        ...
        ['procedure_modality_id' => '6', 'procedure_document_id' => '46', 'number' => '6'],

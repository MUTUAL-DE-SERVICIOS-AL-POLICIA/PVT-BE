...
class EconomicComplementRolSeeder extends Seeder
{
    ...
    public function run()
    {
        $statuses = [
            ...
            ['module_id' => 2, 'name' => 'Module'],
            ['module_id' => 2, 'name' => 'PensionEntity'],
            ['module_id' => 2, 'name' => 'ProcedureDocument'],
            ['module_id' => 2, 'name' => 'City'],
            ['module_id' => 2, 'name' => 'ProcedureModality'],
            ['module_id' => 2, 'name' => 'ProcedureRequirement'],
            ['module_id' => 2, 'name' => 'ProcedureType'],
            ['module_id' => 2, 'name' => 'Role'],
            ['module_id' => 2, 'name' => 'RoleUser'],

...
class Affiliate extends Model
{
  ...
  {
    return $this->morphToMany('Muserpol\Models\ObservationType', 'observable')->withPivot(['user_id', 'date', 'message', 'enabled', 'deleted_at'])->whereNull('observables.deleted_at')->withTimestamps();
  }

...
//    }
    public static function getNextCite($user_id, $role_id, $retirement_fund_id){        
        $year =  date('Y');
        $inc = RetFunIncrement::where('user_id',$user_id)->where('role_id',$role_id)

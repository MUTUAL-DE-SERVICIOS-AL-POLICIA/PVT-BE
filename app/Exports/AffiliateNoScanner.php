...
class AffiliateNoScanner  implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    {
        $data = null;
        $query = "SELECT distinct a.id, concat(a.first_name, ' ', a.second_name, ' ', a.last_name, ' ', a.mothers_last_name) as fullname, a.identity_card
        from affiliates a 
        inner join economic_complements ec on a.id = ec.affiliate_id";

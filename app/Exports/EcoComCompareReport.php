                    ...
                    if ($old) {
                        if (
                            ...
                            $rows->push(array(
                                ...
                                'tramite_anterior' => $old->code,
                                'tramite_actual' => $one->code,
                                "aps_total_FSA Anterior" => $old->aps_total_fsa,
                                "aps_total_FSA Actual" => $one->aps_total_fsa,
                                "aps_total_FS Anterior" => $old->aps_total_fs,
                                "aps_total_FS Actual" => $one->aps_total_fs,
                                "aps_total_CC Anterior" => $old->aps_total_cc,
                                "aps_total_CC Actual" => $one->aps_total_cc,

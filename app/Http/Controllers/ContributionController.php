...
//                $contribution->total = $total;
    ...
    public function printCertification60($id)
    {
        ...
        $contributions=DB::table('ret_fun_contribution')
                        ...
                        ->select('contributions.month_year','contributions.gain','contributions.base_wage','contributions.seniority_bonus','contributions.total','ret_fun_contribution.type')
                        ->get();
        $reimbursements=DB::table('ret_fun_reimbursements')
                        ...
                        ->select('reimbursements.month_year','reimbursements.gain','reimbursements.base_wage','reimbursements.seniority_bonus','reimbursements.total')
                        ->get();

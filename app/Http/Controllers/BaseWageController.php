...
class BaseWageController extends Controller
{
    ...
    {
        $select = DB::raw("base_wages.month_year as month_year, c1.amount as c1, c3.amount as c3, c4.amount as c4, c5.amount as c5, c6.amount as c6, c7.amount as c7, c8.amount as c8, c9.amount as c9, c10.amount as c10, c11.amount as c11, c12.amount as c12");
        $base_wages = DB::table('base_wages')->select($select)
            ...
            ->groupBy('base_wages.month_year', 'c1.amount', 'c3.amount', 'c4.amount', 'c5.amount', 'c5.amount', 'c6.amount', 'c7.amount', 'c8.amount', 'c9.amount', 'c10.amount', 'c11.amount', 'c12.amount');

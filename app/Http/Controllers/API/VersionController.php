    ...
    public function version(Request $request) {
        ...
        switch($store) {
            case 'playstore':
                ...
                return ($version == "2.2.1" || $version == "2.2.0" || $version == "2.2.2" || $version == "3.0.0" || $version == "3.0.2" || $version == "3.0.3" || $version == "3.0.5")? $this->get_version(true, $url_store) : $this->get_version(false, $url_store);
            case 'appstore':
            ...
            case 'appgallery':
                ...
                return ($version == "2.2.1" || $version == "2.2.2" || $version == "3.0.0" || $version == "3.0.2" || $version == "3.0.3" || $version = "3.0.4" || $version = "3.0.5")? $this->get_version(true, $url_store) : $this->get_version(false, $url_store);
            default:
                return response()->json([
                    'error' => true,

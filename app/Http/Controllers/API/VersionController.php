    ...
    public function version(Request $request) {
        ...
        switch($store) {
            case 'playstore':
                ...
                return $version == "2.2.0" ? $this->get_version(true, $url_store) : $this->get_version(false, $url_store);
            case 'appstore':
                $url_store = 'https://apps.apple.com/app/id284815942';
                return $version == "2.1.1" ? $this->get_version(true, $url_store) : $this->get_version(false, $url_store);
            case 'appgallery':
                $url_store = '';
                return $version == "2.1.1" ? $this->get_version(true, $url_store) : $this->get_version(false, $url_store);
            default:

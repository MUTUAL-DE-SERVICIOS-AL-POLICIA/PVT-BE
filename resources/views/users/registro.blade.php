    ...
    <div class="panel panel-primary">
        ...
        <div class="ibox-content">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name='username' id="username" placeholder="Usuario" value=@if(isset($user)) "{{$user->username}}"@endif>
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label">Nombres</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name='first_name' id="first_name" placeholder="Nombre" value=@if(isset($user)) "{{$user->first_name}}"@endif>
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label">Apellidos</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name='last_name' id="last_name" placeholder="Apellidos" value=@if(isset($user)) "{{$user->last_name}}"@endif>
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label">Celular</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name='phone' id="phone" placeholder="Celular" value=@if(isset($user)) "{{$user->phone}}"@endif>
                </div>
            </div>
            <div class="form-group">

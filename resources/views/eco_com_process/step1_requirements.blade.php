    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="form-group" :class="{'has-error': errors.has('procedure_modality_id') }">
                ...
                <div class="col-sm-8">
                    <select class="form-control m-b" ref="procedure_modality_id" name="procedure_modality_id" @change="onChooseModality" v-model="procedure_modality_id"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error': errors.has('reception_type_id') }">
                ...
                <div class="col-sm-8">
                    <select class="form-control m-b" ref="reception_type_id" name="reception_type_id" @change="onChooseCity" v-model="reception_type_id"
                        v-validate.initial="'required'">
        ...
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error': errors.has('pension_entity_id') }">
                ...
                <div class="col-sm-8">
                    <select class="form-control" v-model="pension_entity_id" ref="pension_entity_id" name="pension_entity_id" id="pension_entity_id" v-validate.initial="'required'">
                        <option :value="null"></option>
                    ...
                    <span v-show="errors.has('pension_entity_id')" class="text-danger">@{{ errors.first('pension_entity_id') }}</span>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error': errors.has('city_id') }">
                ...
                <div class="col-sm-8">
                    <select class="form-control m-b" ref="city" name="city_id" @change="onChooseCity" v-model="city_id" v-validate.initial="'required'">
                        <option :value="null"></option>

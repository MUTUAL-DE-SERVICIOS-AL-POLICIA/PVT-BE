...
<div>
    ...
    <p class="text-justify">
        ...
        en mi calidad de viuda (o), mediante declaración de pensión/contrato (adjunto), DECLARO que
        <span class="font-bold">soy beneficiaria(o) (derechohabiente) con una prestación en curso de pago del Sistema Integral de Pensiones (SIP), 
        del afiliado fallecido: {{ $affiliate->fullName() }}</span>, 

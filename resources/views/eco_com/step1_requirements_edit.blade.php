        ...
        <div class="ibox-content">
            ...
            <form id="brianytati">
                ...
                <div v-if='rol != 11'>
                    ...
                    <select data-placeholder="Documentos adicionales..." class="chosen-select" id="aditional_requirements" name="aditional_requirements[]"
                        multiple="" style="width: 350px; display: none;" tabindex="-1" v-bind:disabled="!editing">

...
<div class="row">
    ...
    @include('eco_com.step1_requirements_edit')
            ...
            <div id="tab-eco-com-boleta" class="tab-pane">
                <eco-com-boleta :affiliate="{{ $affiliate }}" :affiliatedevice="{{ $affiliatedevice }}" :affiliatetoken="{{$affiliatetoken}}" inline-template>
                    @include('eco_com.boleta',['affiliate'=>$affiliate,'economic_complement'=>$economic_complement,'fotofrente'=>$fotofrente,'fotosonriente'=>$fotosonriente,'fotoizquierda'=>$fotoizquierda,'fotoderecha'=>$fotoderecha,'fotocianverso'=>$fotocianverso,'fotocireverso'=>$fotocireverso,'fotoboleta'=>$fotoboleta, 'affiliatedevice'=>$affiliatedevice,'affiliatetoken'=>$affiliatetoken])
                </eco-com-boleta>
            </div>
        </div>
    </div>

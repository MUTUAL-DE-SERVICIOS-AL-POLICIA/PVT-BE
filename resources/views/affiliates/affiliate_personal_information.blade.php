<div class="col-lg-12">
    <div class="panel panel-primary" :class="show_spinner ? 'sk-loading' : ''">
        ...
        <div class="row">
            ...
            <div class="col-md-3"><input type="text" v-model="form.identity_card" class="form-control" :disabled="!editing"></div>
            <div class="col-md-2"><strong>Lugar de expedición:</strong></div>
            <div class="col-md-3">{!! Form::select('city_identity_card_id',
        ...
        <div class="row">
            ...
            <div class="col-md-3"><input type="text" v-model="form.first_name" class="form-control" :disabled="!editing"></div>
            <div class="col-md-2"><strong>Segundo Nombre:</strong></div>
            <div class="col-md-3"><input type="text" v-model="form.second_name" class="form-control" :disabled="!editing"></div>
            <div class="col-md-1"></div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-md-3"><input type="text" v-model="form.last_name" class="form-control" :disabled="!editing"></div>
            <div class="col-md-2"><strong>Apellido Materno:</strong></div>
            <div class="col-md-3"><input type="text" v-model="form.mothers_last_name" class="form-control" :disabled="!editing"></div>
            <div class="col-md-1"></div>
        </div>
        <br>
        <div class="row" v-show="affiliate.gender === 'F'">
            ...
            <div class="col-md-3"><input type="text" class="form-control" :disabled="!editing"></div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">{!! Form::select('gender', ['F'=>'Femenino','M'=>'Masculino'], null, ['placeholder' => 'Seleccione genero', 'class' => 'form-control','v-model'=> 'form.gender',':disabled'=>'!editing']) !!}</div>
            <div class="col-md-2"><strong>Estado Civil:</strong></div>
            <div class="col-md-3"> {!! Form::select('civil_status', ['C'=>'Casado(a)','S'=>'Soltero(a)','V'=>'Viuido(a)','D'=>'Divorciado(a)'], null, ['placeholder'=> 'Seleccione estado civil', 'class' => 'form-control','v-model' => 'form.civil_status',':disabled'=>'!editing' ]) !!}</div>
            <div class="col-md-1"></div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-md-3">{!! Form::select('city_birth_id', $birth_cities, null , ['placeholder' => 'Seleccione la expedición del ci', 'class' => 'form-control','v-model'=>'form.city_birth_id',':disabled'=>'!editing']) !!} </div>
            <div class="col-md-1"></div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-md-3"><input v-model="age" type="text" class="form-control" disabled></div>
            <div class="col-md-2"><strong>Telefono:</strong></div>
            <div class="col-md-3"><input type="text" v-model="form.phone_number" class="form-control" :disabled="!editing"></div>
            <div class="col-md-1"></div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-md-3"><input type="text" v-model="form.cell_phone_number" class="form-control" :disabled="!editing"></div>
            <div class="col-md-2"></div>
            <div class="col-md-3"></div>
            <div class="col-md-1"></div>
        </div>

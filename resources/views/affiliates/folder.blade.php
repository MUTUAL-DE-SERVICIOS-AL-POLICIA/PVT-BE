<div class="col-lg-12">
    <div class="panel panel-primary">
                    ...
                    <table class="table table-hover table-sprite">
                        ...
                        @foreach($folders as $folder )
                         <tr>
                           ...
                           <td><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#folderModal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></td>
                           <td><a href="#" class="btn btn-xs btn-primary"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                         </tr>
                        @endforeach
                        </tbody>
                    </table>
        ...
        @include('affiliates.folderModal')
    </div>

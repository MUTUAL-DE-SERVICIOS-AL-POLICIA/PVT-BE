...
<body class="no-border text-xs">
    @for ($i = 0; $i < 3; $i++)
        <div class="m-b-35" style="height:480px !important; border-bottom: 1px dashed #3c3c3c ">
            <table class="w-100 ">
                <tr>
                    ...
                    <th class="w-50 align-top">
                        <div class="font-semibold uppercase leading-tight text-xs">
            ...
            <div class="block">
                ...
                <table class="table-info w-100 m-b-5">
                    <thead class="bg-grey-darker">
                        <tr class="font-medium text-white text-sm">
                            <td class="px-15 text-left text-sm uppercase">
                                NOMBRE COMPLETO
                            </td>
                            <td class="px-15 text-left text-sm uppercase w-30">
                                Cédula de identidad
                            </td>
                            <td class="w-10 px-15 text-right text-sm uppercase">
                                NUP
                            </td>
                        </tr>
                    </thead>
                ...
                <div style="width:500px;height:140px;" class="mx-auto border rounded">
                        <table class="pt-50 ">
                            <tr>
                            ...
                            <tr>
                                <td class="no-border text-center text-base w-100">
                                    ...
                                    <div class="text-xs text-center uppercase" style="width: 450px; margin:0 auto; font-weight:100">{!! $user->position !!}</div>
                                </td>
                            </tr>
                        </table>
                </div>

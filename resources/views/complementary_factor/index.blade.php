                ...
                <table class="table table-bordered table-hover" id="complementary_factor_old_age-table">
                    <thead>
                        <tr class="primary">
                            ...
                            <th>Semestre</th>
                            <th>
                                <div data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="00 - GENERALES">GENERALES</div>
                            </th>
                            <th>
                                <div data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="01 - JEFES Y OFICIALES">JEFES Y OFICIALES</div>
                            </th>
                            <th>
                                <div data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="02 - JEFES Y OFICIALES ADMINISTRATIVOS">JEFES Y OFICIALES ADMTVOS.</div>
                            </th>
                            <th>
                                <div data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="03 - JEFES Y OFICIALES ADMINISTRATIVOS">SUBOFICIALES, CLASES Y POLICIAS</div>
                            </th>
                            <th>
                                <div data-toggle="tooltip" data-placement="top" data-container="body" data-original-title="04 - SUBOFICIALES, CLASES Y POLICIAS ADMINSTRATIVOS">SUBOFICIALES, CLASES Y POLICIAS ADMTVOS.</div>
                            </th>
                        </tr>
                    </thead>
                </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row text-center">
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{!! url('complementary_factor') !!}" class="btn btn-raised btn-danger" data-toggle="tooltip" data-placement="bottom"
                                data-original-title="Cancelar">&nbsp;<i class="glyphicon glyphicon-remove"></i>&nbsp;</a>                            &nbsp;&nbsp;
                            <button type="submit" class="btn btn-raised btn-primary" data-toggle="tooltip" data-placement="bottom" data-original-title="Guardar">&nbsp;<i class="glyphicon glyphicon-floppy-disk"></i>&nbsp;</button>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row text-center">
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{!! route('complementary_factor') !!}" class="btn btn-raised btn-danger" data-toggle="tooltip" data-placement="bottom"
                                data-original-title="Cancelar">&nbsp;<i class="glyphicon glyphicon-remove"></i>&nbsp;</a>                            &nbsp;&nbsp;
                            <button type="submit" class="btn btn-raised btn-primary" data-toggle="tooltip" data-placement="bottom" data-original-title="Guardar">&nbsp;<i class="glyphicon glyphicon-floppy-disk"></i>&nbsp;</button>
                        </div>
                    </div>

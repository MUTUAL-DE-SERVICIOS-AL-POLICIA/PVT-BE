...
<div>
    ...
    <p class="font-bold uppercase">CERTIFICA QUE:</p>
            <p class="text-justify">
                Iniciado el Trámite de {!! $quota_aid->procedure_modality->procedure_type->second_name !!} <strong>N° {{$quota_aid->code}} </strong>de Ventanilla de Atención al
            ...
            <ol class="list-roman">
                ...
                @endif
                <li><strong>TRÁMITE ACTUAL PRESENTADO POR {{$quota_aid->procedure_modality->shortened ?? 'ERROR'}}</strong></li>
                    <p>
                        SOLICITADO POR:
                    </p>

                    ...
                    <table class="table-info w-100 m-b-10">
                        ...
                        <tbody class="table-striped">
                            ...
                            <tr class="text-sm">
                                ...
                                <td class="text-left uppercase font-bold px-5 py-3">{{ Util::getDateFormat($affiliate->getDateEntryAvailability()) }}</td>
                            </tr>
                            <tr class="text-sm">
                            ...
                            <tr class="text-sm">
                                ...
                                <td class="text-left uppercase font-bold px-5 py-3">{{ $retirement_fund->procedure_modality->name }}</td>
                            </tr>
                            <tr class="text-sm">
                                <td class="text-left px-10 py-3 uppercase">regional de registro</td>
                                <td class="text-left uppercase font-bold px-5 py-3">{{ $retirement_fund->city_start->name }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

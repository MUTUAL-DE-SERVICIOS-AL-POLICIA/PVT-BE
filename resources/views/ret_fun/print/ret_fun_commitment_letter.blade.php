...
@section('content')
    <div class="text-justify">
        <span>
            ...
            Yo, .....{!! $affiliate->last_name." ".$affiliate->first_name !!}....., con C.I. N° ....{!! $affiliate->identity_card !!} {!! $affiliate->city_identity_card->first_shortened ?? " "!!}...., como funcionario de público de la Policía Boliviana, DECLARO encontrarme en la siguiente situación de:
        </span>
        <ul>
            <li>
                {{ $glosa }}
        ...
        <tr>
            <th class="no-border text-center">
                <p class="font-bold">----------------------------------------------------<br>
                    AFILIADO<br>
                {!! $affiliate->last_name." ".$affiliate->first_name !!}<br/>
                </p>
            </th>
            <th class="no-border text-center">
                <p class="font-bold">----------------------------------------------------<br>

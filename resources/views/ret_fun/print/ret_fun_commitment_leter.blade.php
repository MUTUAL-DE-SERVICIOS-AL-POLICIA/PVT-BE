...
@section('content')
    <div class="text-justify">
        <span>
            ...
            Yo, .....{!! $bene->last_name." ".$bene->first_name !!}....., con C.I. N° ....{!! $bene->identity_card !!} {!! $bene->city_identity_card->first_shortened ?? " "!!}...., como funcionario de público de la Policía Boliviana, DECLARO encontrarme en la siguiente situación de:
        </span>
        <ul>
            <li>
                {{ $glosa }}

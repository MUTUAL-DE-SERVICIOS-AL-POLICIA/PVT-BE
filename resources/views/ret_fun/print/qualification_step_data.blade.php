            ...
            <tbody class="table-striped">
                @if (sizeOf($discounts)>0)
                    <tr class="text-sm">
                        ...
                        <td class="text-right uppercase font-bold px-5 py-3"> {{ $retirement_fund->subtotal_ret_fun }} </td>
                        <td class="text-center uppercase font-bold px-5 py-3"> Bs. </td>
                    </tr>
                @endif
                @foreach ($discounts as $d)
                    <tr class="text-sm">
                        ...
                        <td class="w-25 text-right uppercase px-5 py-3"> {{ $d->pivot->amount }} </td>
                ...
                <tr class="text-lg">
                    ...
                    <td class="text-right uppercase font-bold px-5 py-3"> {{ $retirement_fund->total_ret_fun }} </td>
                    <td class="text-center uppercase font-bold px-5 py-3"> Bs. </td>
                </tr>
            </tbody>
        </table>

            ...
            <div class="panel-body ">
                <div class="col-md-6">
                    <dl class="dl-">
                        ...
                        <dd>{{ $affiliate->identity_card }} {{ !!$affiliate->city_identity_card ? $affiliate->city_identity_card->first_shortened
                            : '' }}</dd>
                        <dt>Primer Nombre:</dt>
        ...
        @else
            <div class="panel-body ">
                <div class="col-md-6">
                    <dl class="dl-">
                        <dt>Cedula de identidad:</dt>
                        <dd>{{ $applicant->identity_card }} {{ !!$applicant->city_identity_card ? $applicant->city_identity_card->first_shortened
                            : '' }}</dd>
                        <dt>Primer Nombre:</dt>

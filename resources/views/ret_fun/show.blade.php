                    ...
                    <div class="tab-content">
                            ...
                            <div id="tab-summited-document" class="tab-pane">
                                ...
                                @can('view',new Muserpol\Models\RetirementFund\RetFunSubmittedDocument)
                                    ...
                                    <ret-fun-step1-requirements-edit :affiliate="{{ $affiliate }}" :ret_fun="{{ $retirement_fund }}" :modalities="{{ $modalities }}" :requirements="{{ $requirements }}" :user="{{ $user }}" :cities="{{ $cities }}" :procedure-types="{{$procedure_types}}" :submitted="{{$submit_documents}}" :rol="{{Muserpol\Helpers\Util::getRol()->id}}">

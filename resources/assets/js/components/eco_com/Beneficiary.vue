      ...
      <div class="ibox-content" v-if="can('read_eco_com_beneficiary')">
        <div class="row">
          <div class="col-md-12">
            ...
            <br>
            <div v-if="ecoCom.eco_com_modality.procedure_modality_id == 30" >
                ...
                <div class="col-md-6" :class="{'has-error': errors.has('eco_com_beneficiary_official') }">
                  ...
                  <div class="col-md-8">
                    <input
                      ...
                      :disabled="editable"
                    >
                    <div v-show="errors.has('eco_com_beneficiary_official')">
                      <i class="fa fa-warning text-danger"></i>
                      <span class="text-danger">{{ errors.first('eco_com_beneficiary_official') }}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6" :class="{'has-error': errors.has('eco_com_beneficiary_book')}">
                  ...
                  <div class="col-md-8">
                    <input
                      ...
                      :disabled="editable"
                    >
                    <div v-show="errors.has('eco_com_beneficiary_book')">
                      <i class="fa fa-warning text-danger"></i>
                      <span class="text-danger">{{ errors.first('eco_com_beneficiary_book') }}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6" :class="{'has-error': errors.has('eco_com_beneficiary_departure') }">
                  ...
                  <div class="col-md-8">
                    <input
                      ...
                      :disabled="editable"
                    >
                    <div v-show="errors.has('eco_com_beneficiary_departure')">
                      <i class="fa fa-warning text-danger"></i>
                      <span class="text-danger">{{ errors.first('eco_com_beneficiary_departure') }}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6" :class="{'has-error': errors.has('eco_com_beneficiary_marriage_date')}">
                  ...
                  <div class="col-md-8">
                    <input
                      ...
                      :disabled="editable"
                    >
                    <div v-show="errors.has('eco_com_beneficiary_marriage_date')">
                      <i class="fa fa-warning text-danger"></i>
                      <span class="text-danger">{{ errors.first('eco_com_beneficiary_marriage_date') }}</span>
                    </div>
                  </div>
                </div>
              </div>

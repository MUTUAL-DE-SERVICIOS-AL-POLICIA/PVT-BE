        ...
        <form method="get" class="form-horizontal">
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div
                class="col-md-6"
                :class="{'has-error': errors.has('ecoComBeneficiary.city_birth_id') }"
              >
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                  <select
                    class="form-control"
                    disabled
                    name="ecoComBeneficiary.city_birth_id"
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="col-md-8">
                  <select
                    class="form-control"
                    name="ecoComBeneficiary.civil_status"
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-8">
                  <input
                    ...
                    name="ecoComBeneficiary.due_date"
                    v-model.trim="ecoComBeneficiary.due_date"
                    class="form-control"
                    v-date
                  >
                  <br>
                  <input type="checkbox" v-model="ecoComBeneficiary.is_duedate_undefined">
                </div>
              </div>
            </div>
            <br>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-8">
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <div v-for="(phone,index) in beneficiaryPhoneNumbers" :key="phone.value">
                        <div class="input-group">
                          <input
                            type="text"
                          ...
                          <span class="input-group-btn">
                            <button
                              ...
                              v-show="beneficiaryPhoneNumbers.length > 1"
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-8">
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <div v-for="(cell_phone,index) in beneficiaryCellPhoneNumbers" :key="cell_phone.value">
                        <div class="input-group">
                          <input
                            type="text"
...
export default {
  ...
  mounted() {
    ...
    console.log(this.ecoComBeneficiary);
  },
  computed: {
    ecoComBeneficiary() {
    ...
    beneficiaryPhoneNumbers1() {
      if (this.ecoComBeneficiary.phone_number) {
        this.beneficiaryPhoneNumbers = this.ecoComBeneficiary.phone_number.split(",").map(x => {
          return { value: x };
        });
      }
      return [];
    },
    beneficiaryCellPhoneNumbers() {
      if (this.ecoComBeneficiary.cell_phone_number) {
        return this.ecoComBeneficiary.cell_phone_number.split(",").map(x => {
          return { value: x };
        });
      }
      return [];
  ...
  methods: {
    addPhoneNumber() {
      if (this.beneficiaryPhoneNumbers.length > 0) {
        let last_phone = this.beneficiaryPhoneNumbers[
          this.beneficiaryPhoneNumbers.length - 1
        ];
        if (last_phone.value && !last_phone.value.includes("_")) {
          this.beneficiaryPhoneNumbers.push({ value: null });
        }
      } else {
        this.beneficiaryPhoneNumbers.push({ value: null });
      }
    ...
    deletePhoneNumber(index) {
      this.beneficiaryPhoneNumbers.splice(index, 1);
      if (this.beneficiaryPhoneNumbers.length < 1) this.addPhoneNumber();
    },
    addCellPhoneNumber() {

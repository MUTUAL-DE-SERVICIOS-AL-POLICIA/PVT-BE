<template>
    <div class="row">
        ...
        <div class="ibox-title">
            <h2 class="pull-left">Notas del afiliados</h2>
    ...
    <modal name="note-modal" class="p-sm" height="auto">
      ...
      <div class="row">
        <div class="col-md-12" :class="{'has-error': errors.has('action') }">
          <div class="col-md-3">
...
export default {
props: ["affiliate", "permissions", "noteRecords"],
    data() {
    return {
        form: {
        message: null
    ...
    async save() {
     ...
     await this.$validator.validateAll();
      ...
      console.log(this.form.affiliateId);
      if (this.method == "delete") {
        this.form = { data: this.form };
      }
      await axios[this.method](`/affiliate_note_${option}`, this.form)
        .then(response => {

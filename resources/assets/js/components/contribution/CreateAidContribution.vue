                ...
                <div class="panel-body" id ="print">  
                    ...
                    <table class="table table-striped" data-page-size="15">
                        ...
                        <tr>
                            ...
                            <th data-hide="phone" class="footable-visible footable-sortable">Renta<span class="footable-sort-indicator"></span></th>
                            <th data-hide="phone" class="footable-visible footable-sortable">Renta Dignidad<span class="footable-sort-indicator"></span></th>
                            <th data-hide="phone" class="footable-visible footable-sortable">A.M.<span class="footable-sort-indicator"></span></th>

        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <label>Mes</label>
                    <select class="form-control" name="month" id="month" v-model="reimbursement_month" readonly disabled>
...
<script>
import { parseMoney } from "../../helper.js";
export default {
    props: [
  ...
  methods: {
      ...
      calculateReimbursement(){
        ...
        axios.get('/calculate_reimbursement/'+this.afi_id+'/'+amount+'/'+this.reimbursement_month)
        .then(response => {
      ...
      Guardar(){
        ...
        if(this.contributions.length > 0)
        {
            ...
            cancelButtonText: 'Cancelar'
                ...
                axios.post('/contribution_process/contribution_save', {
                    aportes,
                    total:this.total,

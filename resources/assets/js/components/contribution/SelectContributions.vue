        ...
        <div class="col-md-12 " style="padding-top: 5px;padding-left: 0px" >
            <div class="ibox float-e-margins ibox-primary my-content-select-contributions" :class="{'sk-loading': showLoading}">
                <div class="ibox-content cont">
                    ...
                    <div class="row">
                        <div class="col-md-1">
                            <label style="font-size:80%;"> {{ last_date | monthYear }} </label>
                            ...
                            <label style="font-size:80%;"> {{ first_date | monthYear }} </label>
                        </div>
                        <div class="col-md-9">
...
export default {
  ...
  methods:{
    count1(id){
        return this.contributions.filter(item => item.contribution_type_id == id).length;
    },
    countTotal(id){
        return this.contributions.filter(item => item.contribution_type_id).length;
    },
    ...
    save(){
        if(!this.count1(null))
        {
            ...
            var data = {'ret_fun_id':this.retfunid,'contributions':this.contributions};
